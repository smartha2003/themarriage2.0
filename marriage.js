...
var FemaleColor = rgba(255, 255, 255, 1.0)
var MaleColor = rgba(34, 28, 22, 1.0)

// var Blue = rgba(86, 131, 178, 1.0)
// var Purple = rgba(147, 52, 199, 1.0)
// var Pink = rgba(0, 0, 200, 1.0)
// var Green = rgba(2, 197, 41, 1.0)
// var Gray = rgba(39, 39, 39, 1.0)
// var LightGreen = rgba(195, 200, 124)
// var Red = rgba(214, 7, 42, 1.0)

var SplashBackgroundColor = rgba(248, 233, 219)
// var BackgroundColors = [Blue, Purple, Pink, Green, Gray, Gray]
var BackgroundColors = [
    rgba(195, 200, 124, 1.0),   // Green
    rgba(210, 199, 255, 1.0),   // Purple
    rgba(255, 192, 203, 1.0),  // Pink
    rgba(250, 193, 125, 1.0),   // Orange
    rgba(96, 148, 26, 1.0), // Good Green
    rgba(177, 212, 224)  // Blue
];
...
var FemaleGrowthWhenElementDisappears = -10
...
var MaleHitsElementLifeIncrease = 3
var MaleHitsBlackElementGrowth = -12
var MaleLifeIncreaseOnKiss = 12
var MaleGrowthSpeedOnCharacterTouch = -10
...
function drawSplash(alpha)
{
	...
	// Text
	var textColor = rgba(105, 35, 7, alpha)
	var titlePosition = vector2(400, 255)
	var creditsPosition = vector2(mScreen.width - 22, mScreen.height - 27)
	
	drawText('The relationship', titlePosition, 25, 'center', textColor)
	drawText('Shubhada\'s 2023 adaptation of R H 2006', creditsPosition, 12,  'right', textColor)
